...
(function() {
    ...
    const config = {
        ...
        businessId: null, // Must be provided by the website owner
    ...
    function mergeConfig(userConfig) {
        ...
        if (!config.businessId) {
            console.error('ChatbotWidget Error: businessId is required');
            return false;
        }
...
// Usage example:
// ChatbotWidget.init({
//     businessId: 'BUS-1143',        // Required: Your business ID
